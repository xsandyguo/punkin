...
public:
    ...
    inline Operand(BasicDataType type, char val):type_(type){
        SetCharVal(val);
    }

    inline Operand(BasicDataType type, byte val):type_(type){
        SetByteVal(val);
    }

    inline Operand(BasicDataType type, short val):type_(type){
        SetShortVal(val);
    }

    inline Operand(BasicDataType type, int val):type_(type){
        SetIntVal(val);
    }

    inline Operand(BasicDataType type, long val):type_(type){
        SetLongVal(val);
    }

    inline Operand(BasicDataType type, float val):type_(type){
        SetFloatVal(val);
    }

    inline Operand(BasicDataType type, double val):type_(type){
        SetDoubleVal(val);
    }
    ...
    inline jchar GetCharVal(){return this->val_.c;}
    inline jbyte GetByteVal(){return this->val_.b;}
    inline jshort GetShortVal(){return this->val_.s;}
    inline jint GetIntVal(){return this->val_.i;}
    inline jlong GetLongVal(){return this->val_.j;}
    inline jfloat GetFloatVal(){return this->val_.f;}
    inline jdouble GetDoubleVal(){return this->val_.d;}
    inline jobject GetRefVal(){return this->val_.l;}

    inline void SetCharVal(jchar val){this->val_.c = val;}
    inline void SetByteVal(jbyte val){this->val_.b = val;}
    inline void SetShortVal(jshort val){this->val_.s = val;}
    inline void SetIntVal(jint val){this->val_.i = val;}
    inline void SetLongVal(jlong val){this->val_.j = val;}
    inline void SetFloatVal(jfloat val){this->val_.f = val;}
    inline void SetDoubleVal(jdouble val){this->val_.d = val;}
    inline void SetRefVal(jobject val){this->val_.l = val;}
